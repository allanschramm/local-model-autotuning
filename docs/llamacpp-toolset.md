...
Examples installed: `llama.cpp-releases/upstream/b11149/` (nightly CUDA 13.4, post-`v0.5.0`, supports `spark2_5` + Nemotron-3.5 MTP; `--spec-type` adds `draft-dspark`), `llama.cpp-releases/turboquant/tqp-v0.3.0/`, and `llama.cpp-releases/prismml/prism-b10669-6f1c690/` (Windows CUDA 12.4/13.3 prebuilts).
...
- Installed examples: `llama.cpp-releases/upstream/b11149/` (CUDA 13.4), `llama.cpp-releases/turboquant/tqp-v0.3.0/`, and `llama.cpp-releases/prismml/prism-b10669-6f1c690/` (Windows CUDA 12.4/13.3 prebuilts).

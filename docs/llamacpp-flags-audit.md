...
- Release `b11149` (nightly CUDA 13.4, post-`v0.5.0` `7fe450e`) embeds MTP `nextn_predict_layers` and `spark2_5`; `--spec-type` adds `draft-dspark` (verify harness `SPEC_TYPE` values before use)

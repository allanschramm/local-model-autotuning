...
## Semana 2 — Qualidade dos LLMs (flexível)
...
Lições `0001`–`0010` (curso genérico anterior) foram **substituídas** por este mapa. Guias avançados ficam em `reference/` como consulta complementar.

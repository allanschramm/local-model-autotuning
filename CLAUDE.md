...
This project is indexed by GitNexus as **local-model-autoresearch** (902 symbols, 1342 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
